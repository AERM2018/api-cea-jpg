...
const getGroupDaysAndOverdue = async (id_group = 0, date = {}) => {
  ...
  if (
    ...
    overdue =
      moment(date).endOf("month").diff(moment(first_day_date), "weeks") * 100;
  } else {
    overdue = 0;
  }
...
// TODO: Agregar tabla de time table de extra courses
const getExtraCourseDates = async (id_ext_cou = 0) => {};
module.exports = {
