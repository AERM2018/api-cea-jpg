const queries = {
    ...
    "getStuInfo" : "SELECT id_student, matricula, CONCAT(name,' ',surname_f,' ',surname_m) as student_fullname, name_group, id_group, campus_name, CONCAT(educational_level, ' en ', major_name) AS major_name, ins_date FROM stu_info WHERE id_student = :id",
