...
employeesRouter.get("/", [validateJWT], getAllEmployees);
employeesRouter.post(
  ...
  [
    ...
    check(
      "name",
      "El nombre del empleado es obligatorio y debe de tener como maximo 35 caracteres"
    )
      .not()
      .isEmpty()
      .isLength({ max: 35 }),
    ...
    check(
      "salary",
      "El salario del empleado es obligatorio y debe ser un flotante"
    )
      .isFloat()
      .exists({ checkNull: true }),
...
employeesRouter.put(
  ...
  [
    //ID CHECARSE
    param("id", "El id del empleado es una cadena de texto y es obligatorio")
      .isString()
      .notEmpty(),
    check(
      "name",
