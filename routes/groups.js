...
const { checkGroupExistence, checkCourseExistence, checkGroupCourseExistence, checkMajorExistence, checkTeacherExistence } = require('../middlewares/dbValidations');
...
groupsRouter.post('/', [
    check('id_major', 'El id de la cerrera es obligatorio y tiene que ser un numero entero').notEmpty().isNumeric(),
...
groupsRouter.put('/:id_group', [
    param('id_group', 'El id del grupo es obligatorio y debe ser un numero entero').isNumeric(),
    checkGroupExistence,
    validateFields,
    validateJWT
