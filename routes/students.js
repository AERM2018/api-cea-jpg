...
studentsRouter.post('/',[
    ...
    check('group_chief','El campo de jefe de grupo es obligatorio').notEmpty().isInt(),
    ...
    check('birthdate','La fecha de nacimiento del estudiante es obligatoria').isDate(),
    ...
    check('id_group','El grupo al cual va a pertenecer el alumno es obligatorio').isInt().exists({checkNull:true}),
    check('id_campus','El campus donde es incrito el alumno es obligatorio').isInt().exists({checkNull:true}),
