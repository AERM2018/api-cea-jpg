...
teachersRouter.get("/", [validateJWT], getAllTeachers);
...
teachersRouter.post(
  ...
  [
    ...
    check(
      "name",
      "El nombre del profesor es obligatorio y debe de tener como maximo 35 caracteres"
    )
      .not()
      .isEmpty()
      .isLength({ max: 35 }),
...
teachersRouter.put(
  ...
  [
    param(
      "id",
      "El id del maestro tiene que ser una cadena de texto y es obligatoria "
    )
      .isString()
      .notEmpty(),
    check(
    ...
    // check(
    //   "rfc",
    //   "El RFC es obligatorio y tiene que tener como maximo 13 caracteres"
    // )
    //   .not()
    //   .isEmpty()
    //   .isLength({ max: 13 }),
...
teachersRouter.delete(
  ...
  [
    param(
      "id",
      "el id del maestro tiene que ser una cadena de texto y es obligatorio"
    )
      .isString()
      .notEmpty(),
    validateFields,
...
teachersRouter.get("/courses", [validateJWT], getAllCoursesTeachersGiven);
